  ...
  return <header className={`nav ${scrolled ? "scrolled":""}`}>
    <div className="container nav-inner">
      ...
      <nav className={`nav-links ${open ? "open":""}`}>
        ...
        <a className="platform-login" href="/academy-hub" onClick={()=>setOpen(false)}>NOVA HUB</a><button className="nav-theme" aria-label="Mavzuni almashtirish"><Sun size={19}/></button><a className="platform-login" href="/login" onClick={()=>setOpen(false)}>LOGIN</a>
      </nav>
