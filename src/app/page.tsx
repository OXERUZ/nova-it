...
] as const).map(([n,t,d,Icon])=><div className="feature feature-rich" key={n}><div className="feature-top"><span className="feature-num">{n}</span><Icon size={19}/></div><h3>{t}</h3><p className="muted">{d}</p></div>)}</div>
      </div></section>
